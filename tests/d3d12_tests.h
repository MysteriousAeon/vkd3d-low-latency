...
decl_test(test_fence_pending_signal_cpu_rewind_plain);
decl_test(test_fence_ping_pong_deadlock_stress_plain);
decl_test(test_fence_signal_order_deadlock_stress_plain);
decl_test(test_fence_signal_availability_plain);
decl_test(test_fence_pending_signal_cpu_rewind_shared);
...
decl_test(test_immediate_constant_buffer_dxbc);
decl_test(test_immediate_constant_buffer_dxil);
...
decl_test(test_dispatch_huge_groups);
...
decl_test(test_undefined_typed_read_structured_raw_dxbc);
decl_test(test_undefined_typed_read_structured_raw_dxil);
...
decl_test(test_rayquery_root_desc);
decl_test(test_rayquery_root_table);
...
decl_test(test_view_instancing_indirect_state);
...
decl_test(test_deferred_clears);
decl_test(test_deferred_clears_dsv_layout);
