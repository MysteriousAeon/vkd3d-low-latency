...
namespace pacer {
    ...
    public:
        ...
        using TimePoint = dxvk::Sleep::TimePoint;
        ...
        void sleepUntil( const TimePoint& t ) {
            ...
            if constexpr (!threadedSleep) {
                dxvk::Sleep::sleepUntil(dxvk::high_resolution_clock::now(), t);
                return;
            }
            ...
            if (dxvk::high_resolution_clock::now() - std::chrono::microseconds(100) < t2) {
    ...
    private:
        ...
        std::atomic<TimePoint> m_t = { dxvk::high_resolution_clock::now() };
